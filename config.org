...
* Font Settings (Mostly from Howard Abrams)

List of links that may be helpful to setup fonts and stuffs
...
** Quickly find file in a project

TODO: for some reason the search are very slow to return, find out why?
...
Note: this is the basic settings
...
** My extra package for developer
